...
const initialCalendars: Calendar[] = [
  { id: '1', name: 'School Events', color: 'bg-blue-500' },
  { id: '2', name: 'Holidays', color: 'bg-red-500' },
  { id: '3', name: 'Staff Meetings', color: 'bg-green-500' },
];
...
export const CalendarProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [selectedCalendars, setSelectedCalendars] = React.useState<string[]>(['1', '2', '3']);
